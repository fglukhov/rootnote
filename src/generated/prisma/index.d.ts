...
export namespace Prisma {
  ...
  */
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    author<T extends Post$authorArgs<ExtArgs> = {}>(
      args?: Subset<T, Post$authorArgs<ExtArgs>>,
    ): Prisma__UserClient<
      $Result.GetResult<
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    author<T extends Note$authorArgs<ExtArgs> = {}>(
      args?: Subset<T, Note$authorArgs<ExtArgs>>,
    ): Prisma__UserClient<
      $Result.GetResult<
        Prisma.$UserPayload<ExtArgs>,
        T,
